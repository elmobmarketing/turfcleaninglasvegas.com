...
export function Quote() {
  ...
  useSEO({
    ...
    description: 'Get a free, no-obligation quote for professional turf cleaning in Las Vegas. Services from $299. Pet odor removal, deep cleaning, and maintenance. We respond as soon as we can.',
    canonical: '/quote',
    schema: schemas,
  });

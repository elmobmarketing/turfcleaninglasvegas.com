    ...
    <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
      ...
      <div className="bg-vegas-navy text-white py-2">
        <div className="max-w-6xl mx-auto px-4 flex justify-between items-center text-sm">
          <span>Serving Las Vegas, Henderson, Summerlin & Surrounding Areas</span>
          <a href={PHONE_HREF} className="font-semibold hover:text-vegas-gold transition-colors phone-link">
